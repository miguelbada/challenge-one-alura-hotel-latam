...
public class RegistroHuesped extends JFrame {
	 ...
	 * Create the frame.
	 */
	public RegistroHuesped(Integer nReserva) {
		this.idReserva = nReserva;
		...
		txtNreserva.setText(String.valueOf(getIdReserva()));
	}
	
	private void guardar() {
		
		if(this.txtNombre.getText() != null && this.txtApellido.getText() != null && txtFechaN.getDate() != null && txtNacionalidad.getSelectedItem() != null && txtTelefono.getText() != null && txtNreserva.getText() != null) {
			String fechaN = ((JTextField) txtFechaN.getDateEditor().getUiComponent()).getText();
			System.out.print(fechaN);
			
			Huesped huesped = new Huesped(this.txtNombre.getText(), this.txtApellido.getText(), java.sql.Date.valueOf(fechaN), String.valueOf(txtNacionalidad.getSelectedItem()), txtTelefono.getText(), Integer.valueOf(txtNreserva.getText()));
			idReserva = this.huespedController.guardar(huesped);
			
			JOptionPane.showMessageDialog(this, "Registro numero " + idReserva + " guardado satisfactoriamente");
	...
	public void setIdReserva(Integer numero) {
		this.idReserva = numero;	
	}
