...
public class Reservas extends JFrame {
	...
	public Reservas() {
		...
		this.txtFechaE = new JDateChooser();
		...
		this.txtFechaS = new JDateChooser();
	...
	private Integer guardar() {
		...
		if(this.txtFechaE.getDate() != null && this.txtFechaS.getDate() != null) {
			...
			Reserva reserva = new Reserva(java.sql.Date.valueOf(fechaE), java.sql.Date.valueOf(fechaS), txtValor.getText(), String.valueOf(txtFormaPago.getSelectedItem()));
